    ...
    <body>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="well">
                    <input type="text" class="form-control" id="nome" value="${linguagem?.name}" required />
                </div>
                <h2>Nome do Robô</h2>
                <div class="well">
                    <input type="text" class="form-control" id="robo" value="${linguagem?.robot}" required />
                </div>
                <h2>Descrição da Linguagem</h2>
                <div class="well">
                    <textarea class="form-control" rows="3" id="descricao" value="${linguagem?.description}" required ></textarea>
                </div>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <div class="row">
            <div class="col-lg-12">
                ...
                <p>
                    ...
                    <div class="well">
                        <input type="text" class="form-control" id="codigoDeCompilacao" value="${linguagem?.compileCode}" required />
                    </div>
                </p>
                <p>
                    <h4>Extensão dos arquivos na linguaem:</h4>
                    <div class="well">
                        <input type="text" class="form-control" id="extensao" value="${linguagem?.extension}" required />
                    </div>
                </p>
                <p>
                ...
                <p>
                    ...
                    <div class="well">
                        <input type="text" class="form-control" id="codigoDeEnvio" value="${linguagem?.sendCode}" required />
                    </div>
                </p>
                <p>
                    <h4>Extensão do arquivo enviado:</h4>
                    <div class="well">
                        <input type="text" class="form-control" id="extensaoDoArquivo" value="${linguagem?.sentExtension}" required />
                    </div>
                </p>
                <p>
        ...
        <div class="row">
            <div class="col-lg-6">
                <h3>Cabeçalho</h3>
                <div class="well">
                    <textarea class="form-control" rows="3" id="cabecalho" value="${linguagem?.header}" required></textarea>
                </div>
            </div>
            <div class="col-lg-6">
                <h3>Rodapé</h3>
                <div class="well">
                    <textarea class="form-control" rows="3" id="rodape" value="${linguagem?.footnote}" required></textarea>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="well">
                    <textarea class="form-control" rows="11" id="funcaoPrincipal" required>${linguagem?.mainFunction}</textarea>
                </div>
            </div>
            <div class="col-lg-4">
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="well">
                    <textarea class="form-control" rows="7" id="chamadaDeFuncao" required>${linguagem?.callFunction}</textarea>
                </div>
            </div>
            <div class="col-lg-4">
                <h4>Linguagem R-Educ</h4>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="well">
                    <textarea class="form-control" rows="7" id="texto" required>${linguagem?.types.declareString}</textarea>
                </div>
            </div>
            <div class="col-lg-4">
                <h4>Linguagem R-Educ</h4>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="well">
                    <textarea class="form-control" rows="7" id="numero" required>${linguagem?.types.declareFloat}</textarea>
                </div>
                <p>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="well">
                    <textarea class="form-control" rows="7" id="booleano" required>${linguagem?.types.declareBoolean}</textarea>
                </div>
                <p>
        ...
        <div class="row">
            <div class="col-lg-3">
                <h4>Verdadeiro</h4>
                <div class="well">
                    <textarea class="form-control" rows="7" id="verdadeiro" required>${linguagem?.types.declareTrue}</textarea>
                </div>
            </div>
            <div class="col-lg-3">
                <h4>Linguagem R-Educ</h4>
            ...
            <div class="col-lg-6">
                ...
                <div class="well operadores">
                    <div class="form-group input-group">
                        ...
                        <input type="text" class="form-control" id="e" value="${linguagem?.operators.logicalAnd}" required />
                    </div>
                    <div class="form-group input-group">
                        <span class="input-group-addon">ou</span>
                        <input type="text" class="form-control" id="ou" value="${linguagem?.operators.logicalOr" required />
                    </div>
                    <div class="form-group input-group">
                        <span class="input-group-addon">!</span>
                        <input type="text" class="form-control" id="nao" value="${linguagem?.operators.logicalNot}" required />
                    </div>
                    <div class="form-group input-group">
                        <span class="input-group-addon">=</span>
                        <input type="text" class="form-control" id="igual" value="${linguagem?.operators.equalTo}" required />
                    </div>
                    <div class="form-group input-group">
                        <span class="input-group-addon">!=</span>
                        <input type="text" class="form-control" id="diferente" value="${linguagem?.operators.notEqualTo}" required />
                    </div>
                    <div class="form-group input-group">
                        <span class="input-group-addon">&gt;</span>
                        <input type="text" class="form-control" id="maior" value="${linguagem?.operators.greaterThan}" required />
                    </div>
                    <div class="form-group input-group">
                        <span class="input-group-addon">&gt;=</span>
                        <input type="text" class="form-control" id="maiorOuIgual" value="${linguagem?.operators.greaterThanOrEqualTo}" required />
                    </div>
                    <div class="form-group input-group">
                        <span class="input-group-addon">&lt;</span>
                        <input type="text" class="form-control" id="menor" value="${linguagem?.operators.lessThan}" required />
                    </div>
                    <div class="form-group input-group">
                        <span class="input-group-addon">&lt;=</span>
                        <input type="text" class="form-control" id="menorOuIgual" value="${linguagem?.operators.lessThanOrEqualTo}" required />
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row">
            <div class="col-lg-8">
                <h4>Se</h4>
                <div class="well">
                    <textarea class="form-control" rows="16" id="se" required>${linguagem?.controlFlow.ifCode}</textarea>
                </div>
            </div>
            <div class="col-lg-4">
                <h4>Linguagem R-Educ</h4>
        ...
        <div class="row">
            <div class="col-lg-8">
                <h4>Enquanto</h4>
                <div class="well">
                    <textarea class="form-control" rows="11" id="enquanto" required>${linguagem?.controlFlow.whileCode}</textarea>
                </div>
            </div>
            <div class="col-lg-4">
                <h4>Linguagem R-Educ</h4>
        ...
        <div class="row">
            <div class="col-lg-8">
                <h4>Repita</h4>
                <div class="well">
                    <textarea class="form-control" rows="11" id="repita" required>${linguagem?.controlFlow.repeatCode}</textarea>
                </div>
            </div>
            <div class="col-lg-4">
                <h4>Linguagem R-Educ</h4>
        ...
        <div class="row">
            <div class="col-lg-8">
                <h4>Teste</h4>
                <div class="well">
                    <textarea class="form-control" rows="18" id="teste" required>${linguagem?.controlFlow.switchCode}</textarea>
                </div>
            </div>
            <div class="col-lg-4">
                <h4>Linguagem R-Educ</h4>
        ...
        <div class="row">
            <div class="col-lg-8">
                <h4>Para</h4>
                <div class="well">
                    <textarea class="form-control" rows="17" id="para" required>${linguagem?.controlFlow.forCode}</textarea>
                </div>
            </div>
            <div class="col-lg-4">
                <h4>Linguagem R-Educ</h4>
        ...
        <div class="row">
            <div class="col-lg-8">
                <h4>Farei</h4>
                <div class="well">
                    <textarea class="form-control" rows="11" id="farei" required>${linguagem?.controlFlow.doCode}</textarea>
                </div>
            </div>
            <div class="col-lg-4">
                <h4>Linguagem R-Educ</h4>
        ...
        <div class="row">
            <div class="col-lg-8">
                <h4>Sair</h4>
                <div class="well">
                    <textarea class="form-control" rows="7" id="sair" required>${linguagem?.controlFlow.breakCode}</textarea>
                </div>
            </div>
            <div class="col-lg-4">
                <h4>Linguagem R-Educ</h4>
