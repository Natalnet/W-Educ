        ...
        <form action="<g:createLink action="salvar"/>" method="post">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2>Nome do Robô</h2>
                    <div class="well">
                        <input type="text" class="form-control" id="robo" name="robo" required />
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p>
                        ...
                        <div class="well">
                            <input type="text" class="form-control" id="codigoDeCompilacao" name="codigoDeCompilacao" required />
                        </div>
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        <div class="well">
                            <input type="text" class="form-control" id="codigoDeEnvio" name="codigoDeEnvio" required />
                        </div>
                    </p>
                    <p>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="well">
                        <textarea class="form-control" rows="11" id="funcaoPrincipal" name="funcaoPrincipal" required></textarea>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="well">
                        <textarea class="form-control" rows="11" id="funcao" name="funcao"></textarea>
                    </div>
                </div>
                <div class="col-lg-4">
                    <h4>Linguagem R-Educ</h4>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="well">
                        <textarea class="form-control" rows="7" id="chamadaDeFuncao" name="chamadaDeFuncao" required></textarea>
                    </div>
                </div>
                <div class="col-lg-4">
                    <h4>Linguagem R-Educ</h4>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="well">
                        <textarea class="form-control" rows="7" id="numero" name="numero" required></textarea>
                    </div>
                    <p>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="well">
                        <textarea class="form-control" rows="7" id="booleano" name="booleano" required></textarea>
                    </div>
                    <p>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <h4>Verdadeiro</h4>
                    <div class="well">
                        <textarea class="form-control" rows="7" id="verdadeiro" name="verdadeiro" required></textarea>
                    </div>
                </div>
                <div class="col-lg-3">
                    <h4>Linguagem R-Educ</h4>
                ...
                <div class="col-lg-3">
                    <h4>Falso</h4>
                    <div class="well">
                        <textarea class="form-control" rows="7" id="falso" name="falso"required></textarea>
                    </div>
                </div>
                <div class="col-lg-3">
                    <h4>Linguagem R-Educ</h4>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="well operadores">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input type="text" class="form-control" id="nao" name="nao" required />
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon">=</span>
                            <input type="text" class="form-control" id="igual" name="igual" required />
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon">!=</span>
                            <input type="text" class="form-control" id="diferente" name="diferente" required />
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon">&gt;</span>
                            <input type="text" class="form-control" id="maior" name="maior" required />
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon">&gt;=</span>
                            <input type="text" class="form-control" id="maiorOuIgual" name="maiorOuIgual" required />
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon">&lt;</span>
                            <input type="text" class="form-control" id="menor" name="menor" required />
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon">&lt;=</span>
                            <input type="text" class="form-control" id="menorOuIgual" name="menorOuIgual" required />
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-8">
                    <h4>Se</h4>
                    <div class="well">
                        <textarea class="form-control" rows="16" id="se" name="se" required></textarea>
                    </div>
                </div>
                <div class="col-lg-4">
                    <h4>Linguagem R-Educ</h4>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <h4>Enquanto</h4>
                    <div class="well">
                        <textarea class="form-control" rows="11" id="enquanto" name="enquanto" required></textarea>
                    </div>
                </div>
                <div class="col-lg-4">
                    <h4>Linguagem R-Educ</h4>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <h4>Repita</h4>
                    <div class="well">
                        <textarea class="form-control" rows="11" id="repita" name="repita" required></textarea>
                    </div>
                </div>
                <div class="col-lg-4">
                    <h4>Linguagem R-Educ</h4>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <h4>Teste</h4>
                    <div class="well">
                        <textarea class="form-control" rows="18" id="teste" name="teste" required></textarea>
                    </div>
                </div>
                <div class="col-lg-4">
                    <h4>Linguagem R-Educ</h4>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <h4>Para</h4>
                    <div class="well">
                        <textarea class="form-control" rows="17" id="para" name="para" required></textarea>
                    </div>
                </div>
                <div class="col-lg-4">
                    <h4>Linguagem R-Educ</h4>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <h4>Farei</h4>
                    <div class="well">
                        <textarea class="form-control" rows="11" id="farei" name="farei" required></textarea>
                    </div>
                </div>
                <div class="col-lg-4">
                    <h4>Linguagem R-Educ</h4>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <h4>Sair</h4>
                    <div class="well">
                        <textarea class="form-control" rows="7" id="sair" name="sair" required></textarea>
                    </div>
                </div>
                <div class="col-lg-4">
                    <h4>Linguagem R-Educ</h4>
