                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <g:link class="btn btn-success btn-xs" controller="gerenciar" action="alternarProf" id="${professor?.id}">Alternar para Aluno</g:link>
                                                    <g:link class="btn btn-info btn-xs" controller="erro" action="exibirP" id="${professor?.id}">Estatísticas</g:link>
                                                    <g:link class="btn btn-warning btn-xs" controller="mensagem" action="escreverUsuario" id="${professor?.id}">Enviar Mensagem</g:link>
                                                    <g:link class="btn btn-danger btn-xs" controller="gerenciar" action="desativar" id="${professor?.id}" params="[tipo: 'Professor']">Desativar</g:link>
                                                </td>
                                            </tr>
                                            </g:each>
                                        </tbody>
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>${professor?.username}</td>
                                                <td>
                                                    <g:link class="btn btn-success btn-xs" controller="gerenciar" action="ativar" id="${professor?.id}" params="[tipo: 'Professor']">Ativar</g:link>
                                                    <g:link class="btn btn-info btn-xs" controller="erro" action="exibirP" id="${professor?.id}">Estatísticas</g:link>
                                                </td>
                                            </tr>
                                            </g:each>
